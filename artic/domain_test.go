...
// HTTP behaviour is covered in artic_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "artic://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("artic", "about")
	if err != nil || got.String() != "artic://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want artic://page/about", got.String(), err)
	}
}
