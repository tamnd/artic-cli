...
Most of these come down to network reality or how artic serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

artic rate-limits like any public site. artic already paces
...
Where a surface is gated, artic reads a cookie or token you supply
...
`artic`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what artic actually did
